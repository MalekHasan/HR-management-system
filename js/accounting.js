...
let salarySum=sumSalrayOfAdmin+sumSalrayOfDev+sumSalrayOfFin+sumSalrayOfMarket;
function renderTable() {
    ...
    adminRow.textContent=`Avg for Administration =${sumSalrayOfAdmin / numOfAdmin}`;
    tableData.appendChild(adminRow);
    finRow.textContent=`Avg for Finance =${sumSalrayOfFin / numOfFin}`;
    tableData.appendChild(finRow);
    markRow.textContent=`Avg for Marketing =${sumSalrayOfMarket / numOfMarket}`;
    tableData.appendChild(markRow);
    devRow.textContent=`Avg for Development =${sumSalrayOfDev / numOfDev}`;
    ...
    totalAvgSalry.textContent=`Avg Salray for All Employees= ${salarySum/numSum}`;
